<template>
	<view>
		<view class="box-bg">
			<uni-nav-bar shadow  left-text="取消" @clickLeft="back" title="修改手机号码" />
		</view>
		
		<uni-easyinput class="inputM" trim="all" v-model="newMobile"
		placeholder="请输入手机号" placeholderStyle="color:#A6A6A6;font-size:16px"
